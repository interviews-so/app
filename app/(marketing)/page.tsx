...
const faq = [
  {
    question: "Are you a sourcing company?",
    answer:
  ...
  {
    question: "Why make these scenarios?",
    answer:
...
const features = [
  ...
  },
  {
    ...
    title: "Language Agnostic Scenarios",
    description:
  ...
  },
  {
    ...
    title: "All Aspects of the Interview",
    description:
  ...
  },
  {
    ...
    title: "Helpful Guides and Rubrics",
    description:
    ...
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          <Link
            ...
            target="_blank"
          >
            Check out interview best practices
          </Link>
          <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
            Interview scenarios to find your next{" "}
          ...
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            Upgrade your technical interview process with our library of
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            We believe that technical interviews should reflect daily activities
            — instead of rote memorization. We&apos;re building a library of
            real-world programming scenarios to own your interview process and
            find your next technical hire.
          </p>
        </div>
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[200px] flex-col justify-between rounded-md p-6">
                <svg
                  ...
                  fillRule={
                    feature.fillRule as SVGAttributes<SVGSVGElement>["fillRule"]
                  }
                >
        ...
        <div className="mx-auto text-center md:max-w-[58rem]">
          <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            We also provide a blog and other resources on interview best
            practices to help you find your next hire and build an interview
      ...
      >
        <div className="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem]">
          ...
          <p className="text-center leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Get full access to our library with one payment. No hidden fees or
            re-ups.
          </p>
        </div>
        <div className="grid w-full items-start gap-10 rounded-lg p-10 md:grid-cols-[1fr_200px]">
          <div className="grid gap-6">
            ...
            <ul className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Full Library Access
              </li>
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Lifetime Access
              </li>
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Free Updates
              </li>
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> Support via Email
              </li>
              <li className="flex items-center">
                <Icons.check className="mr-2 h-4 w-4" /> 30 Day Money Back
              </li>
            </ul>
          </div>
      ...
      <section id="faq" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
          ...
          <div className="grid pt-8 text-left dark:border-gray-700 md:grid-cols-2 md:gap-8 md:gap-x-16">
            {faq.map((item) => (
              <div className="mb-8 md:mb-0">
                <h3 className="mb-4 flex items-center text-lg font-medium text-gray-900 dark:text-white">
                  <svg
                    className="mr-2 h-5 w-5 flex-shrink-0 text-muted-foreground dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
